  ...
  const projects = [
    {
      ...
      description:
        "Site pessoal desenvolvido com React, Vite, Tailwind e hospedado no GitHub Pages. Idealizado para refletir minha identidade como desenvolvedor e artista visual.",
      tags: ["React", "Vite", "Tailwind CSS", "GitHub Pages"],
      liveUrl: "https://fmgermano.github.io/felipe-mateus-studio",
      githubUrl: "https://github.com/fmgermano/felipe-mateus-studio",
      featured: true,
    },
    /*  {
  ...
  const blogPosts = [
    {
      ...
      date: "2024-01-15",
      excerpt:
        "Lessons learned from architecting large-scale Angular applications with proper state management and performance optimization.",
    ...
    },
    {
      ...
      date: "2024-01-08",
      excerpt:
        "Exploring CSS Grid, Flexbox, and Container Queries for responsive web design.",
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-stone-600 font-light leading-relaxed max-w-2xl">
            Aqui você encontra alguns dos projetos que desenvolvi. Gosto de
            construir soluções com propósito, explorar ideias e entregar com
            qualidade.
          </p>
        </div>
          ...
          <div className="grid gap-8">
            {projects
              ...
              .map((project, index) => (
                <div
                  key={index}
                  className="bg-white border border-stone-200 p-8 hover:shadow-lg transition-shadow"
                >
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                    <h3 className="text-xl font-light text-stone-900 mb-2 md:mb-0">
                      {project.title}
                    </h3>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {projects
              ...
              .map((project, index) => (
                <div
                  key={index}
                  className="bg-white border border-stone-200 p-6 hover:shadow-lg transition-shadow"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map((tag, tagIndex) => (
                      <span
                        key={tagIndex}
                        className="px-2 py-1 bg-stone-100 text-stone-700 text-xs font-light"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        {/*         <section>
          ...
          <div className="space-y-6">
            {blogPosts.map((post, index) => (
              <article
                key={index}
                className="bg-white border border-stone-200 p-6 hover:shadow-lg transition-shadow cursor-pointer"
              >
