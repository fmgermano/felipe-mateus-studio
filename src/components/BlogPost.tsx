        ...
        <article className="prose prose-stone prose-lg max-w-none">
          <ReactMarkdown
            ...
            components={{
              h1: ({ node, ...props }) => (
                <h1
                  className="text-3xl font-light text-stone-900 mt-12 mb-6"
                  {...props}
                />
              ),
              h2: ({ node, ...props }) => (
                <h2
                  className="text-2xl font-light text-stone-900 mt-10 mb-4"
                  {...props}
                />
              ),
              h3: ({ node, ...props }) => (
                <h3
                  className="text-xl font-light text-stone-900 mt-8 mb-3"
                  {...props}
                />
              ),
              p: ({ node, ...props }) => (
              ...
              pre: ({ node, ...props }) => (
                <pre
                  className="bg-stone-100 p-4 rounded-lg overflow-x-auto mb-6"
                  {...props}
                />
              ),
              ul: ({ node, ...props }) => (
              ...
              li: ({ node, ...props }) => (
                <li className="text-stone-700" {...props} />
              ),
              blockquote: ({ node, ...props }) => (
                <blockquote
                  className="border-l-4 border-stone-300 pl-6 italic text-stone-600 my-6"
                  {...props}
                />
              ),
            }}
